...
class Color {
    ...
    constructor(code) {
        ...
        if (!regex.test(code))
            throw new errors_js_1.InvalidParameter("code", "in the format '5;[0-255]' or 2;[red];[green];[blue]");
        this.#code = code;
    }
    get code() {
        return this.#code;
    ...
    static get random() {
        return Color.rgb((0, util_js_1.rand)(0, 255), (0, util_js_1.rand)(0, 255), (0, util_js_1.rand)(0, 255));
    }
    static get randomBright() {
        return Color.hsl((0, util_js_1.rand)(0, 360), 100, (0, util_js_1.rand)(50, 85));
    }
    static get randomDim() {
        return Color.hsl((0, util_js_1.rand)(0, 360), 50, (0, util_js_1.rand)(15, 50));
    }
    static table256(index) {
        if (index > 255 || index < 0)
            throw new errors_js_1.InvalidParameter("index", "a number between 0-255");
        return new Color(`5;${index}`);
    }
    static rgb(red, green, blue) {
        if (green > 255 || green < 0)
            throw new errors_js_1.InvalidParameter("green", "a number between 0-255");
        if (blue > 255 || blue < 0)
            throw new errors_js_1.InvalidParameter("blue", "a number between 0-255");
        if (red > 255 || red < 0)
            throw new errors_js_1.InvalidParameter("red", "a number between 0-255");
        return new Color(`2;${red};${green};${blue}`);
    }
    static hsl(hue, saturation, lightness) {
        if (hue > 360 || hue < 0)
            throw new errors_js_1.InvalidParameter("hue", "a number between 0-360");
        if (saturation > 100 || saturation < 0)
            throw new errors_js_1.InvalidParameter("saturation", "a number between 0-100");
        if (lightness > 100 || lightness < 0)
            throw new errors_js_1.InvalidParameter("lightness", "a number between 0-100");
    ...
    static hex(hexCode) {
        if (!/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/.test(hexCode))
            throw new errors_js_1.InvalidParameter("hexCode", "a valid hex color code.");
